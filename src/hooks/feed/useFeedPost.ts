...
import { getCommentsByMediaId, togglePostLike } from "@/actions/interactions/interaction";

export function useFeedPost(post: ExtendedPost): [FeedPostState, FeedPostActions] {
