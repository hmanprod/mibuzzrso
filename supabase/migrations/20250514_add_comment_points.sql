-- Créer la fonction pour ajouter des points pour un commentaire
...
BEGIN
    ...
    INSERT INTO points_history (user_id, points_change, source, source_id)
    VALUES (v_media_owner_id, 5, 'comment_received', p_comment_id);
