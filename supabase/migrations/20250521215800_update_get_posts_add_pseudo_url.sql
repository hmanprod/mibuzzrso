-- Update get_posts function to include pseudo_url in profile data
...
-- Comment on function
COMMENT ON FUNCTION get_posts IS 'Get posts with various filters: regular feed, profile posts, liked posts, or search results. Now includes pseudo_url in profile data.';
